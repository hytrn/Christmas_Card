...
document.getElementById("showButton").addEventListener("click", function () {
  ...
  // Toggle the active class to replicate hover behavior
  if (card.classList.contains("active")) {
    card.classList.remove("active"); // Remove effects if already applied
    button.textContent = "Open Card"; // Change button text back
  } else {
    card.classList.add("active"); // Apply the hover-like effects
    button.textContent = "Close Card"; // Change button text back
  }
});
